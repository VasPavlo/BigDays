...
namespace BigDays.Pixabay
{
    public class PixabayService
    {
        ...
        { 
			var result = await httpClient.GetStringAsync($"{BASE_URL}key={Key}&q={searchText}&response_group=image_details&image_type=photo&orientation=vertical&=min_width=100&min_height=120&safesearch=true&per_page=56");
